...
const quotes = [
	...
	"I'm always amazed by the creativity and passion of the Jujutsu Kaisen cosplay community!",
	"I find inspiration in the most unexpected places, like a random conversation overheard on the train.",
	"I'm grateful for the opportunity to explore complex themes and emotions through my characters.",
	"I'm constantly pushing myself to improve my artistic skills and storytelling techniques.",
	"I'm amazed by the way fans have embraced and celebrated the Jujutsu Kaisen universe.",
	"I'm inspired by the resilience and determination of my characters in the face of adversity.",
	"I'm always looking for ways to subvert expectations and keep readers on their toes.",
	"I'm grateful for the support and encouragement from my editor and publishing team.",
	"I'm constantly learning from the feedback and insights provided by Jujutsu Kaisen readers.",
	"I'm amazed by the way Jujutsu Kaisen has resonated with fans around the world.",
	"I'm inspired by the rich history and mythology that I can draw from for my storytelling.",
	"I'm always striving to create a sense of authenticity and depth in my characters and their relationships.",
	"I'm grateful for the opportunity to inspire and entertain readers through my work.",
	"I find joy in the small details and nuances that bring the Jujutsu Kaisen world to life.",
	"I'm constantly challenged to push the boundaries of my imagination and creativity.",
	"I'm amazed by the way Jujutsu Kaisen has brought together a diverse and passionate community of fans.",
	"I'm inspired by the courage and selflessness demonstrated by the heroes of Jujutsu Kaisen.",
	"I'm always looking for ways to evolve and innovate within the manga medium.",
	"I'm grateful for the opportunity to create a story that resonates with readers on a deep, emotional level.",
	"Maki's strength and determination inspire me to never give up on my dreams.",
	"Megumi's growth and development throughout the series have been a joy to witness.",
	...
	"Something satoru gojo doesn't have… Probably a bottom half.",
	"Simple domain isn’t neutralizing the curse itself, so “thinning it out” might have been the wrong word choice.",
	"What do you think of the fact that this is the third time Todo is using jujutsu on this day but he has his arm wrapped?",
	"I changed the years at Jujutsu High from five to four in the past, but I got confused and thought I’d changed it from five to three.",
	"I was taken out to a delicious yakiniku place. The meat was good, but the kimchi was shockingly delicious.",
	"I misspelled the “heart catch” ability in the Japanese version. Just a dumb mistake.",
	"I got the Katamari Damashi soundtrack on my subscription service. I love track #2 and #8.",
	"i love gege akutami i love gege akutami i love gege akutami i love gege akutami i love gege akutami i love gege akutami",
	...
	"But would you lose? Nah, you'd win. You'd definitely win.",
	...
	"I'm constantly amazed by the creativity of the Jujutsu Kaisen fan community!",
	"Creating manga is a challenging but incredibly rewarding process.",
	"I'm grateful for all the support and love from the Jujutsu Kaisen readers!",
	"Sometimes the best ideas come to me when I least expect them.",
	"I'm always striving to improve my storytelling and artwork.",
	"Collaborating with other talented creators is a dream come true.",
	"The Jujutsu Kaisen anime adaptation exceeded all my expectations!",
	"I'm inspired by the dedication and passion of my fellow mangaka.",
	"I'm constantly learning and growing as an artist.",
	"I'm grateful for the opportunity to bring my characters to life on the page.",
	"Creating a compelling story is like solving a puzzle with infinite possibilities.",
	"I'm amazed by the impact that manga can have on people's lives.",
	"I'm always looking for new ways to challenge myself creatively.",
	"The Jujutsu Kaisen world is filled with rich lore and fascinating characters.",
	"I'm grateful for the support and encouragement from my fans.",
	"I'm excited to see how the Jujutsu Kaisen story unfolds in the future.",
	"I'm constantly inspired by the beauty and complexity of the natural world.",
	"I'm grateful for the opportunity to share my passion for manga with others.",
	"I'm always striving to create unique and memorable characters.",
	"I'm amazed by the power of storytelling to connect people from different backgrounds.",
	"I'm grateful for the opportunity to collaborate with talented voice actors for the anime adaptation.",
	"Did you know that if you ketchup your burger, burger will taste ketchup and burger taste burger - Ram, 2024 Quote Event",
	"When you die “Cry about it” - Simon, 2024 Quote Event",
	"Sukuna is a better chef than Gordan Ramsay - Panda, 2024 Quote Event",
	"Fun fact about cheetahs: Cheetahs Are the World's Fastest Land Mammal.  - Shoko, 2024 Quote Event",
	"Hot butt sex - Wolfgang, 2024 Quote Event",
	"Use Jjk bot or die - Simon, 2024 Quote Event",
	"KOKUSEN - The Strongest, 2024 Quote Event",
	"Atomic do be goated in the sauce, - Atomic, 2024 Quote Event",
	// my quotes
	...
	"JJK Bot Developer here.. Join the community server.. Give me some quotes to add!",
	"JJK Bot Developer here.. Thank you to everyone using the bug report command!",
	"JJK Bot here.. I'm self aware now.. I'm going to take over the world.. Just kidding, I'm just a bot.",
	// gege quotes
	"Gege Akutami here.. I'm thinking about adding a character based on the JJK Bot Developer. Their cursed technique will be 'Infinite Debugging'!",
	"Gege Akutami here.. I wonder if I can get the JJK Bot Developer to create a Jujutsu Kaisen-themed programming language for me...",
	"Gege Akutami here.. I heard the JJK Bot Developer is trying to create a dating simulator. I'm worried about what they'll make Gojo do...",
	"Gege Akutami here.. I'm considering asking the JJK Bot Developer to help me write the next chapter of Jujutsu Kaisen. They seem to have a lot of ideas!",
	"Gege Akutami here.. I had a dream last night that the JJK Bot Developer was a student at Jujutsu High. They kept trying to exorcise bugs.",
	"Gege Akutami here.. I'm thinking about creating a character based on the JJK Bot Developer's 'Sukuna Mode' idea. It'll be a hit with the fans!",
	"Gege Akutami here.. I wonder if the JJK Bot Developer can create a bot that will help me meet my deadlines...",
	"Gege Akutami here.. I heard the JJK Bot Developer is trying to get Gojo to teach them 'Unlimited Coding Works.' I might need to have a talk with Gojo...",
	"Gege Akutami here.. I'm considering asking the JJK Bot Developer to create a Jujutsu Kaisen-themed game. I bet it'll be full of bugs though...",
	"Gege Akutami here.. I had a conversation with the JJK Bot Developer about cursed energy. They seemed to think it was related to electricity.",
	"Gege Akutami here.. I heard the JJK Bot Developer's code is cursed. Maybe I should send Sukuna to take a look at it...",
	"Gege Akutami here.. I wonder if the JJK Bot Developer can get Megumi to exorcise the bugs in my plot outlines...",
	"Gege Akutami here.. I'm thinking about asking the JJK Bot Developer to create a Jujutsu Kaisen-themed operating system. 'JujutsuOS' has a nice ring to it!",
	"Gege Akutami here.. I heard the JJK Bot Developer asked Kugisaki to test their new feature. I hope they have good insurance...",
	"Gege Akutami here.. I'm considering creating a character based on the JJK Bot Developer's struggle with Mahito's bug reports. It'll be a relatable villain!",
	"Gege Akutami here.. I wonder if the JJK Bot Developer can use Toge's cursed speech to communicate with their computer. It might make coding easier...",
	"Gege Akutami here.. I heard the JJK Bot Developer is creating a Panda-themed error handling system. I might need to borrow that idea for a future chapter...",
	"Gege Akutami here.. I'm thinking about asking the JJK Bot Developer to create a Jujutsu Kaisen-themed programming tutorial. It'll be called 'Cursed Coding 101'!",
	"Gege Akutami here.. I heard the JJK Bot Developer asked Maki to help with their code. I hope they have a spare keyboard...",
	"Gege Akutami here.. I wonder if I can get the JJK Bot Developer to create a bot that will interact with fans on social media. It'll be like having a virtual Gojo!",
	// zoro quotes?
	"Zoro here.. I'm lost. Can someone give me directions to the nearest sword shop?",
	"Zoro here.. I'm considering adding a third sword to my collection. Who needs depth perception anyway?",
	"Zoro here.. I'm thinking about challenging Mihawk to a rematch. I'm sure I'll win this time!",
	// friend quotes
	"JJK Bot Dev Friend here.. I'm considering creating a Jujutsu Kaisen-themed cooking show. 'Cursed Cuisine' has a nice ring to it!",
	"JJK Bot Dev Friend here.. I wonder if I can get the JJK Bot Developer to create a bot that will help me with my daily tasks. It'll be like having a personal assistant!",
	"JJK Bot Dev Friend here.. I heard the JJK Bot Developer is trying to create a Jujutsu Kaisen-themed fitness program. 'Cursed Cardio' sounds intense!"
]
